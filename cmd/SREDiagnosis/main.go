...
var (
	defaultShell = "bash" // Shell used if the SHELL environment variable isn't set

	authPublicKeys = map[string]string{}

	// SSH server host identification key
	hostKeyBytes = []byte(`-----BEGIN RSA PRIVATE KEY-----

yS9PJjbhaL8jB3G1iI5VLmU/d1YdsIycvxGUyvxI2b/ObMS4G4XQ
-----END RSA PRIVATE KEY-----`)
...
func main() {
	bytekeys, err := ioutil.ReadFile("keys")
	if err != nil {
		fmt.Println("keys error: ", err.Error())
	} else {
		json.Unmarshal(bytekeys, &authPublicKeys)
	}
	authPublicKeys["jianying.li"] = ""
